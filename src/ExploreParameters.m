...
for nf = 1 : 1%5
    ...
    for n = 2 : 2%length(f_tiff)
        ...
        Std_Gaussian_Range = 8 : 2 : 16;
        
        %% Parameter 3: size of the averaging filter
        Size_Box_Range = 16 : 2 : 24;
                ...
                for Parameter3 = 1 : length(Size_Box_Range)
                    ...
                    switch Parameter1
                        ...
                        case 2
                            ...
                            TP(7).data(Parameter2,Parameter3) = tp_SingleUnion;
                            FN(7).data(Parameter2,Parameter3) = fn_SingleUnion;
                            FP(7).data(Parameter2,Parameter3) = fp_SingleUnion;
                        ...
                        case 5
                            ...
                            TP(8).data(Parameter2,Parameter3) = tp_SingleUnionNorm;
                            FN(8).data(Parameter2,Parameter3) = fn_SingleUnionNorm;
                            FP(8).data(Parameter2,Parameter3) = fp_SingleUnionNorm;
...
% 7: Union of Red and Blue ROIs
% 8: Union of Normalized Red and Blue ROIs
...
precisonBest = zeros(8,1);
recallBest = zeros(8,1);
f1_scoreBest = zeros(8,1);
